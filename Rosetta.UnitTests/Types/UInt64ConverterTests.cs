...
{
	[TestClass]
	public class UInt64ConverterTests : IConverterTests, IParseTests
	{
		#region Methods
		...
		{
			TestHelper.AreEqual(1, Converter.Convert<ulong>(true));
			TestHelper.AreEqual(0, Converter.Convert<ulong>(false));
		}
